...
line1, = plt.plot(d, constraint(d, 2, 5), label='$S=2, D=5$')
line2, = plt.plot(d, constraint(d, 4, 5), linestyle='--', label='$S=4, D=5$')
line3, = plt.plot(d, constraint(d, 8, 5), linestyle=':', label='$S=8, D=5$')
