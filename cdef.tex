...
\author{%
Steinar Midtskogen$^{\ast}$ and Jean-Marc Valin$^{\dag}$\\[0.5em]
{\small\begin{minipage}{\linewidth}\begin{center}
\begin{tabular}{ccc}
$^{\ast}$Cisco Systems Inc. & \hspace*{0.5in} & $^{\dag}$Mozilla Corporation \\
Lysaker, Norway && Mountain View, CA, USA\\
\url{stemidts@cisco.com} && \url{jmvalin@jmvalin.ca}
\end{tabular}
...
%\begin{keywords}enhancement filter, video compression, AV1, Thor\end{keywords}
...
\begin{figure}
\centering{\includegraphics[width=0.18\columnwidth]{dlines0}\hspace{.5em}\includegraphics[width=0.18\columnwidth]{dlines1}\hspace{.5em}\includegraphics[width=0.18\columnwidth]{dlines2}\hspace{.5em}\includegraphics[width=0.18\columnwidth]{dlines3}}

\vspace{.5em}

\centering{\includegraphics[width=0.18\columnwidth]{dlines4}\hspace{.5em}\includegraphics[width=0.18\columnwidth]{dlines5}\hspace{.5em}\includegraphics[width=0.18\columnwidth]{dlines6}\hspace{.5em}\includegraphics[width=0.18\columnwidth]{dlines7}}\caption{Line number $k$ for pixels following direction $d=0:7$ in an $8\times8$
...
\begin{equation}
\sigma_{d}^{2}=\sum_{k}\left[\sum_{p\in P_{d,k}}\left(x_{p}-\mu_{d,k}\right)^{2}\right]\ .\label{eq:direction-variance0}
\end{equation}

Substituting (\ref{eq:pixel-average}) into (\ref{eq:direction-variance0}) and
simplifying results in
\begin{equation}
\sigma_{d}^{2}= \sum_{p}x_{p}^{2}-\sum_{k}\frac{1}{N_{d,k}}\left(\sum_{p\in P_{d,k}}x_{p}\right)^{2}\ .\label{eq:direction-variance1}
\end{equation}
...
\begin{figure}
\centering{\includegraphics[width=0.7\columnwidth]{direction}}\caption{Example of direction search for an $8\times8$ block. The patterns
...
\begin{figure}
\centering{\includegraphics[width=0.6\columnwidth]{strength}}
\caption{Constraint function for different strength values $S$ (constant $D$).\label{fig:constraint-function-strength}}
\end{figure}


\begin{figure}
\centering{\includegraphics[width=0.6\columnwidth]{damping}}
...
\begin{figure}
\centering{\includegraphics[width=0.15\columnwidth]{pri0}\hspace{.5em}\includegraphics[width=0.15\columnwidth]{pri1}\hspace{.5em}\includegraphics[width=0.15\columnwidth]{pri2}\hspace{.5em}\includegraphics[width=0.15\columnwidth]{pri3}}

\vspace{.5em}

\centering{\includegraphics[width=0.15\columnwidth]{pri4}\hspace{.5em}\includegraphics[width=0.15\columnwidth]{pri5}\hspace{.5em}\includegraphics[width=0.15\columnwidth]{pri6}\hspace{.5em}\includegraphics[width=0.15\columnwidth]{pri7}}
...
\begin{figure}
\centering{\includegraphics[width=0.15\columnwidth]{sec0}\hspace{.5em}\includegraphics[width=0.15\columnwidth]{sec1}\hspace{.5em}\includegraphics[width=0.15\columnwidth]{sec2}\hspace{.5em}\includegraphics[width=0.15\columnwidth]{sec3}}
...
\begin{figure}
\centering{\includegraphics[width=0.7\columnwidth]{cdef_vs_nothing}}
...
be used for this filter block.  On inter-predicted frames, the filter
parameters are only coded for filter blocks that are not completely
skipped.  Skipped filter blocks have CDEF disabled.
Similarly, any skipped coding block within a filter block has filtering
disabled unless a skip condition bit is set.
...
Yet~\cite{AWCY} online testing tool using the AV1 codec and Thor codec, both
