...
\caption{Constraint function for different strengths $S$ (constant $D$).\label{fig:constraint-function-strength}}
\end{figure}


\begin{figure}
\centering{\includegraphics[width=0.9\columnwidth]{damping}}
\caption{Constraint function for different damping $D$ (constant $S$).\label{fig:constraint-function-damping}}
\end{figure}
