...
\begin{figure}
\centering{\includegraphics[width=0.23\columnwidth]{dlines0}\hspace{.5em}\includegraphics[width=0.23\columnwidth]{dlines1}\hspace{.5em}\includegraphics[width=0.23\columnwidth]{dlines2}\hspace{.5em}\includegraphics[width=0.23\columnwidth]{dlines3}}

\vspace{.5em}

\centering{\includegraphics[width=0.23\columnwidth]{dlines4}\hspace{.5em}\includegraphics[width=0.23\columnwidth]{dlines5}\hspace{.5em}\includegraphics[width=0.23\columnwidth]{dlines6}\hspace{.5em}\includegraphics[width=0.23\columnwidth]{dlines7}}\caption{Line number $k$ for pixels following direction $d=0:7$ in an $8\times8$
...
\begin{equation}
y\left(i, j\right)=x(i, j) + g\left(\sum_{m,n \in R}w_{m,n}f\left(x\left(m, n) - x(i,j\right)\right)\right)\label{eq:linear-filter}
\end{equation}
where $R$ contains pixels in the 5x5 neighbourhood of $x(i, j)$ with the
...
\begin{figure}
\centering{\includegraphics[width=0.23\columnwidth]{pri0}\hspace{.5em}\includegraphics[width=0.23\columnwidth]{pri1}\hspace{.5em}\includegraphics[width=0.23\columnwidth]{pri2}\hspace{.5em}\includegraphics[width=0.23\columnwidth]{pri3}}

\vspace{.5em}

\centering{\includegraphics[width=0.23\columnwidth]{pri4}\hspace{.5em}\includegraphics[width=0.23\columnwidth]{pri5}\hspace{.5em}\includegraphics[width=0.23\columnwidth]{pri6}\hspace{.5em}\includegraphics[width=0.23\columnwidth]{pri7}}\caption{Primary filter taps following direction $d=0:7$.\label{fig:Primary-filter}}
\end{figure}
