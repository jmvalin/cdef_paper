...
int main(int argc, char **argv)
{
  ...
  for (i=0;i<5;i++)
  {
    for(j=0;j<5;j++)
    {
      ...
      if (i==(2 + dy) && j == (2 + dx)) weight = '1';
      else if (i==(2 - dy) && j == (2 - dx)) weight = '1';
      else if (i==(2 + dx) && j == (2 - dy)) weight = '1';
      else if (i==(2 - dx) && j == (2 + dy)) weight = '1';
      else if (i==(2 + dy/2) && j == (2 + dx/2)) weight = '2';
      else if (i==(2 - dy/2) && j == (2 - dx/2)) weight = '2';
      else if (i==(2 + dx/2) && j == (2 - dy/2)) weight = '2';
      else if (i==(2 - dx/2) && j == (2 + dy/2)) weight = '2';
      else weight = 0;
      if (weight) {
#if 0
        printf("4 1 0 50 -1 0 14 0.0000 4 135 105 %d %d %c\\001\n", TBASEX+SIZE*j-100, TBASEY+SIZE*i-130, weight);
        printf("4 1 0 50 -1 0 14 0.0000 4 135 105 %d %d %c\\001\n", TBASEX+SIZE*j-20, TBASEY+SIZE*i-20, '/');
        printf("4 1 0 50 -1 0 14 0.0000 4 135 105 %d %d 16\\001\n", TBASEX+SIZE*j+80, TBASEY+SIZE*i+80);
#else
  ...
  printf("4 1 0 50 -1 1 24 0.0000 4 135 105 %d %d d\\001\n", (int)(TBASEX+SIZE*2.4)-660, (int)(TBASEY+SIZE*5.2));
  printf("4 1 0 50 -1 0 24 0.0000 4 135 105 %d %d = %d, %d\\001\n", (int)(TBASEX+SIZE*2.4), (int)(TBASEY+SIZE*5.2), pattern, pattern+4);
  return 0;
}
