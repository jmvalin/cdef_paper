...
line1, = plt.plot(d, constraint(d, 2, 3), label='$S=2, D=3$')
line2, = plt.plot(d, constraint(d, 2, 4), linestyle='--', label='$S=2, D=4$')
line3, = plt.plot(d, constraint(d, 2, 5), linestyle=':', label='$S=2, D=5$')
